            ...
            <div id="header">
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="/AccountController/loginAdmin"style="color: #cccccc;text-decoration: none;padding-left:100px">Admin</a>
                    </div>
                </div>
            </div>
                                                ...
                                                <form method="post" action="LoginController">
                                                    <div class="form-outline mb-4">
                                                        <input type="text" id="form2Example17"
                                                               ...
                                                               placeholder="Enter username" required="" id="username" name="username" />
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <input type="password" id="form2Example27"
                                                               class="form-control form-control-lg"
                                                               placeholder="Enter password" required="" id="password" name="password" />
                                                    </div>
                                                    ...
                                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Don't have an
                                                        account? <a href="/AccountController/register"
