<%-- 
    Document   : profile
    Created on : Jan 7, 2024, 10:04:46 AM
    Author     : DELL
--%>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-xlg-3 col-md-12">
                            <div class="white-box">
                                <div class="user-bg"> <img width="100%" alt="user" src="resource/imag/logo.png">
                                    <div class="overlay-box">
                                        <div class="user-content">
                                            <a href="javascript:void(0)"><img src="/resource/<%= acc.getAvatarAdmin()%>"
                                                                              class="thumb-lg img-circle" alt="img"></a>
                                            <h4 class="text-white mt-2"><%= acc.getNameAdmin()%></h4>
                                            <h5 class="text-white mt-2"><%= acc.getEmailAdmin()%></h5>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <form class="form-horizontal form-material">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="col-md-12 border-bottom p-0">
                                                <input type="text" value="<%= acc.getNameAdmin()%>"
                                                       class="form-control p-0 border-0" readonly=""> </div>
                                        </div>
                                        <div class="form-group mb-4">
                                            <label for="example-email" class="col-md-12 p-0">Email</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input type="email" value="<%= acc.getEmailAdmin()%>"
                                        ...
                                        <%
                                            ...
                                            String adminPassword = (String) sessiona.getAttribute("adminPassword");
                                        %>
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0">Password</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input type="text" value="<%=adminPassword%>" class="form-control p-0 border-0">
                                            </div>
                                        </div>
                                        <div class="form-group mb-4">
