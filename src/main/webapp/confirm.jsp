                    ...
                    <div id="formNews">
                        <form id="formCreateBlog" method="post" action="BlogController" enctype="multipart/form-data">
                            ...
                            <div class="input-control">
                                ...
                                <input type="file" id="img1Post" name="img1Post"  value="" placeholder="Chọn hình ảnh thứ 1"  readonly=""/>
                                <input type="hidden" name="img1_default" value="<%= blogOld.getImg1()%>"/>
                                <div class="error"></div>
                            </div>
                            <div class="input-control">
                                <label for="body">Nội dung 2</label>
                                <input type="text" value="<%= blogOld.getContent2()%>" id="content2Post" name="content2Post" placeholder="Nội dung thứ 2"  readonly=""/>
                                <div  class="error"></div>
                            </div>
                            <div class="input-control">
                                <label for="img2">Hình 2</label>
                                <input type="file" id="img2Post" name="img2Post" value="" placeholder="Chọn hình ảnh thứ 2"  readonly=""/>
                            ...
                            <div class="input-control">
                                ...
                                <input type="text" value="<%= blogOld.getContent3()%>" id="content3Post" name="content3Post" placeholder="Nội dung thứ 3"  readonly=""/>
                                <div class="error"></div>
                            </div>
                            <div class="input-control">
                                <label for="img2">Hình 3</label>
                                <input type="file" id="img3Post" name="img3Post" value=""  placeholder="Chọn hình ảnh thứ 3"  readonly=""/>
                            ...
                            <button type="submit" id="submit" name="btnPostBlog">Xác nhận</button>
                        </form>
                    </div>
