...
<html lang="en">
    <head>
        ...
        <title>Trang Home thành viên</title>
        <!-- Favicon-->
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/AccountController/account">Account</a></li>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Welcome to MinhUyenBlog.com</h1>
                        <!--<hr class="divider" />-->
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn- btn-xl" href="/BlogController/writeBlog">Viết Blog</a>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 mb-4 mb-md-0">
                                <div class="post-entry">
                                    <a href="/BlogController/detail/<%= setTopBlogPost.getString("idBlogPost")%>" class="post-thumbnail"><img style="width: 350px; height: 250px" src="/resource/<%= setTopBlogPost.getString("img1Post")%>"  alt="Image" class="img-fluid"></a>
                                    <div class="post-content-entry">
                                        <h3><a href="/BlogController/detail/<%= setTopBlogPost.getString("idBlogPost")%>"><%= setTopBlogPost.getString("nameBlogPost")%></a></h3>
                                        <div class="meta">
                                            <span>by <a href="/BlogController/detail/<%= setTopBlogPost.getString("idBlogPost")%>"><%= setTopBlogPost.getString("nameAuthorPost")%></a></span> <span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
            <div class="col-lg-6">
                ...
                <!-- to get an API token!-->
                <form id="contactForm" action="FeedbackController" data-sb-form-api-token="API_TOKEN">
                    <!-- Name input-->
                    <div class="form-floating mb-3">
                        <input class="form-control" name="name" id="idFeed" type="text" placeholder="Enter your ID..." required="" />
                        <label for="name">ID Feedback</label>
                    ...
                    <!-- Message input-->
                    <div class="form-floating mb-3">
                        <textarea class="form-control" name="feed"  id="message" type="text" placeholder="Enter your message here..." style="height: 10rem" data-sb-validations="required"></textarea>
                    ...
                    <button class="btn btn-dark tn-primary btn-xl btn-lg btn-block"
                            type="submit" name="sendFeedBtn">Gửi phản hồi</button>
                </form>
            </div>
        </div>
        <div class="row gx-4 gx-lg-5 justify-content-center">
