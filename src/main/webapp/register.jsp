                                            ...
                                            <!--<form id="formRegister" method="post" action="/AccountsController"class="w-100" style="margin-top: 100px; margin-bottom: 100px;">-->
                                                <form method="post" action="AccountController"  enctype="multipart/form-data" >
                                                    ...
                                                    <div class="form-outline mb-4">
                                                        <input type="text" id="form2Example17" class="form-control form-control-lg" placeholder="Enter username" required="" name="username"/>
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <input type="password" id="form2Example27" class="form-control form-control-lg" placeholder="Enter password" required="" name="password"/>
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <input type="email" id="form2Example17" class="form-control form-control-lg" placeholder="Enter email" required="" name="email"/>
                                                    </div>
                                                    <div class="form-outline mb-4">
                                                        <input type="hidden" id="form2Example27" class="form-control form-control-lg" placeholder="Enter avatar" value="imag/logo.png" name="avatar"/>
                                                    </div>
<!--                                                    <div class="form-outline mb-4">
                                                    ...
                                                    <div class="pt-1 mb-4" id="login">
                                                        <button class="btn btn-dark btn-lg btn-block" type="submit" name="registerBtn" >Register</button>
                                                    </div>
                                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">You have an account? <a href="/AccountController/login"
